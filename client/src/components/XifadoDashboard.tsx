...
export default function XifadoDashboard() {
  ...
  const phaseCopy = { pre: ["Operação programada", "Aguardando a abertura", "O período de NoFap ainda não começou. O cronômetro oficial inicia em 31/08/2026 às 23:59."], ativo: ["Período de NoFap iniciado", "O cronômetro está valendo", "Cada participante acumula seu próprio tempo desde 01/09/2026 às 00:00 até sobreviver ou ser eliminado."], encerrado: ["Operação concluída", "Placar final congelado", "O período terminou em 01/10/2026 às 00:00. Cada sobrevivente recebe sua patente final e o tempo total de resistência."] }[phase];
  ...
  function removeMember(name: MemberName) {
    ...
    if (!window.confirm(`Remover ${name}? O histórico e a senha serão preservados. O participante ficará inativo e poderá ser adicionado novamente.`)) return;
