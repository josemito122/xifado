...
-- Credenciais do Xifado: somente hashes scrypt; nunca senhas em texto aberto.
...
create trigger xifado_credentials_set_updated_at before update on public.xifado_credentials for each row execute function public.xifado_credentials_set_updated_at();
...
select relname, relrowsecurity, relforcerowsecurity from pg_class where relname = 'xifado_credentials';
